...
function main() {
  ...
  gl.attachShader(program, createShader(gl.VERTEX_SHADER, VERTEX_SHADER_SOURCE));
  gl.attachShader(program, createShader(gl.FRAGMENT_SHADER, FRAGMENT_SHADER_SOURCE));
